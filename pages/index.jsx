            ...
            <DefaultLayout className={"homepage"} hideSidebar>
                <div>
                    ...
                    >
                        ...
                        <p className="slogan" data-aos="fade-up" data-aos-delay="100"
                        ...
                        <div className="columns is-vcentered">
                            <div className="column is-4">
                                <div className="feature" data-aos="fade-up" data-aos-delay="100"
                                     data-aos-offset="200" data-aos-easing="ease-out-quart">
                                    <img src="/static/images/chained.svg" alt="" data-aos="fade-up" data-aos-delay="100"
                                         data-aos-offset="200" data-aos-easing="ease-out-quart"/>
                            ...
                            <div className="column is-4">
                                <div className="feature" data-aos="fade-up" data-aos-delay="150"
                                     data-aos-offset="200" data-aos-easing="ease-out-quart">
                                    <img src="/static/images/chained.svg" alt="" data-aos="fade-up" data-aos-delay="300"
                                         data-aos-offset="200" data-aos-easing="ease-out-quart"/>
                            ...
                            <div className="column is-4">
                                <div className="feature" data-aos="fade-up" data-aos-delay="200"
                                     data-aos-offset="200" data-aos-easing="ease-out-quart">
                                    <img src="/static/images/chained.svg" alt="" data-aos="fade-up" data-aos-delay="500"
                                         data-aos-offset="200" data-aos-easing="ease-out-quart"/>
                    ...
                    <div className="mt-16 content index-section pricing-section">
                        ...
                        <div className="columns w-full justify-around">
                            <div className="column px-4 is-4">
                                <div className="box box-format shadow" data-aos="fade-up" data-aos-delay="100"
                                     data-aos-offset="200" data-aos-easing="ease-out-quart">
                                    ...
                                    <div className="flex w-full justify-center">
                                        <ActiveLink href={"/auth/signup"}>
                                            <button className="button is-primary mt-4">Start Now</button>
                                        </ActiveLink>
                                    </div>
                                </div>
                            </div>
                            <div className="column px-4 is-4">
                                <div className="box box-format" data-aos="fade-up" data-aos-delay="150"
                                     data-aos-offset="200" data-aos-easing="ease-out-quart">
