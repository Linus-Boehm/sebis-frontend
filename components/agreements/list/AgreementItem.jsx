...
class AgreementItem extends React.Component {
  getTag = () => {
    ...
    if (agreement.reviewer_confirmed && agreement.assignee_confirmed) {
      return <span className="tag is-success w-32">Running</span>;
    } else if (agreement.end_date < new Date()) {
      return <span className="tag is-light w-32">Finished</span>;
      ...
      return <span className="tag is-info w-32">Open</span>;
    }
  };
