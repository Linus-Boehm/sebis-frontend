...
import AgreementGoalInfo from "./AgreementGoalInfo";
import { pick } from "lodash";

class AgreementGoalInfoContainer extends React.Component {
  onChangeInput = changes => {
    const { selectedGoal } = this.props;

    this.props.dispatch(
      GoalActions.assignSelectedGoal({
        ...selectedGoal,
        ...changes
      })
    );
...
export default connect(mapStateToProps)(AgreementGoalInfoContainer);
